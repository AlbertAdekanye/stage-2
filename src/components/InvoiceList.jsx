...
const InvoiceList = ({ onEdit, onDelete, onView, filterStatus }) => {
  ...
  const EmptyState = () => (
    <div className="text-center py-16 md:py-20 bg-white dark:bg-gray-800 rounded-2xl shadow-sm">
      {/* Empty state illustration - Replace with your image */}
      <div className="flex justify-center mb-6">
        <img 
          src="/empty-invoice.png" 
      ...
      <p className="text-gray-500 dark:text-gray-400 max-w-sm mx-auto">
        ...
        <br />
        <span className="font-medium text-indigo-600 dark:text-indigo-400">New Invoice</span> button and get started
      </p>
    </div>
  );
  ...
  return (
    <div className="max-w-5xl mx-auto">
      ...
      {/* Conditional Rendering: Empty State vs Invoice List */}
      {emptyState ? (
        <EmptyState />
      ) : (
        <>
          ...
          <div className="hidden md:block">
            <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm overflow-hidden">
              ...
              {/* Invoice rows (desktop table view) */}
