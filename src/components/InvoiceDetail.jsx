  ...
  return (
    <div className="max-w-4xl mx-auto">
      ...
      <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-6 mb-4">
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          ...
          <div className="flex gap-3">
            ...
            {/* Mark as paid (only for pending invoices) */}
      ...
      <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-6">
        ...
        {/* Header: invoice ID + description + sender info */}
        ...
        <div className="mt-8 bg-gray-50 dark:bg-gray-900 rounded-lg overflow-hidden">
          ...
          <div className="p-4 sm:p-6">
            ...
            {invoice.items.map((item, index) => (
              <div
                key={index}
                className="grid grid-cols-2 sm:grid-cols-4 gap-4 py-3 border-b border-gray-200 dark:border-gray-700 last:border-0"
              >
                ...
                <div className="text-gray-500 dark:text-gray-400 sm:text-center">
                  {item.quantity}
                </div>

                <div className="text-gray-500 dark:text-gray-400 sm:text-right">
